        ...
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioVenta">
            ...
            <div class="box-body">
              ...
              if (!$ventas) {
              $codigo = 10001; // Si no hay ventas, comienza en 10001
              } else {
                   $codigos = array(); // Almacena todos los códigos de venta

                   foreach ($ventas as $venta) {
                    
                       $codigos[] = $venta["codigo"];
                 }
                   $codigo = max($codigos) + 1; // Encuentra el máximo y suma 1
